...
//                *source.track_type){}
        ...
        landbasedtracked(std::string name="None", int x=0, int y=0, double speed = 0, double width = 0, double length = 0, double height = 0, double capacity = 0, char directions = 'N') : landbasedrobot(name, x, y, speed, width, length, height, capacity, directions){};
